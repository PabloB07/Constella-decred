...
var (
	...
	regNetGenesisBlock = wire.MsgBlock{
		Header: wire.BlockHeader{
			...
			Timestamp:   time.Unix(1547871618, 0), // 2018-10-03 00:00:00 +0000 UTC
			PoolSize:    uint32(0),
...
var regNetParams = &chaincfg.Params{
	...
	PubKeyAddrID:         [2]byte{0x41b4, 0xe5}, // starts with Rk
	PubKeyHashAddrID:     [2]byte{0x41b4, 0x00}, // starts with Rs
	PKHEdwardsAddrID:     [2]byte{0x41b4, 0xe0}, // starts with Re
	PKHSchnorrAddrID:     [2]byte{0x41b4, 0xc2}, // starts with RS
	ScriptHashAddrID:     [2]byte{0x41b4, 0xdb}, // starts with Rc
	PrivateKeyID:         [2]byte{0x41b4, 0xfe}, // starts with Pr
