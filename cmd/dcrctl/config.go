...
var (
	dcrdHomeDir            = dcrutil.AppDataDir("constella", false)
	dcrctlHomeDir          = dcrutil.AppDataDir("constellatl", false)
	dcrwalletHomeDir       = dcrutil.AppDataDir("constellawallet", false)
	defaultConfigFile      = filepath.Join(dcrctlHomeDir, "constellactl.conf")
...
func createDefaultConfigFile(destinationPath string) error {
	...
	dcrdConfigPath := filepath.Join(dcrdHomeDir, "constella.conf")
